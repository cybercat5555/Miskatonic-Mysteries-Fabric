...
import com.miskatonicmysteries.client.model.entity.phantasma.PhantasmaV1Model;
...
public class PhantasmaV1Renderer extends GeoEntityRenderer<PhantasmaEntity> {
    public PhantasmaV1Renderer(EntityRenderDispatcher dispatcher) {
        super(dispatcher, new PhantasmaV1Model());
        this.shadowRadius = 0;
    }
