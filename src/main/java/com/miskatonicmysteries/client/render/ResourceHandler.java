...
public class ResourceHandler {
    ...
    public static void init() {
        ...
        ResourceHandler.addOctagramTextureFor(ModObjects.CTHULHU_OCTAGRAM, new Identifier(Constants.MOD_ID, "blocks/octagrams/cthulhu_octagram"));
        ResourceHandler.addOctagramTextureFor(ModObjects.HASTUR_OCTAGRAM, new Identifier(Constants.MOD_ID, "blocks/octagrams/hastur_octagram"));
        ResourceHandler.addOctagramTextureFor(ModObjects.SHUB_OCTAGRAM, new Identifier(Constants.MOD_ID, "blocks/octagrams/shub_octagram"));
        ...
        addStatueTextureFor(ModObjects.CTHULHU_STATUE_GOLD, new Identifier(Constants.MOD_ID, "blocks/statues/cthulhu_statue_gold"));
        addStatueTextureFor(ModObjects.CTHULHU_STATUE_MOSSY, new Identifier(Constants.MOD_ID, "blocks/statues/cthulhu_statue_mossy"));
        addStatueTextureFor(ModObjects.CTHULHU_STATUE_PRISMARINE, new Identifier(Constants.MOD_ID, "blocks/statues/cthulhu_statue_prismarine"));
        addStatueTextureFor(ModObjects.CTHULHU_STATUE_STONE, new Identifier(Constants.MOD_ID, "blocks/statues/cthulhu_statue_stone"));

        addStatueTextureFor(ModObjects.HASTUR_STATUE_GOLD, new Identifier(Constants.MOD_ID, "blocks/statues/hastur_statue_gold"));
        addStatueTextureFor(ModObjects.HASTUR_STATUE_MOSSY, new Identifier(Constants.MOD_ID, "blocks/statues/hastur_statue_mossy"));
        addStatueTextureFor(ModObjects.HASTUR_STATUE_TERRACOTTA, new Identifier(Constants.MOD_ID, "blocks/statues/hastur_statue_terracotta"));
        addStatueTextureFor(ModObjects.HASTUR_STATUE_STONE, new Identifier(Constants.MOD_ID, "blocks/statues/hastur_statue_stone"));

        addStatueTextureFor(ModObjects.SHUB_STATUE_GOLD, new Identifier(Constants.MOD_ID, "blocks/statues/shub_statue_gold"));
        addStatueTextureFor(ModObjects.SHUB_STATUE_MOSSY, new Identifier(Constants.MOD_ID, "blocks/statues/shub_statue_mossy"));
        addStatueTextureFor(ModObjects.SHUB_STATUE_BLACKSTONE, new Identifier(Constants.MOD_ID, "blocks/statues/shub_statue_blackstone"));
        addStatueTextureFor(ModObjects.SHUB_STATUE_STONE, new Identifier(Constants.MOD_ID, "blocks/statues/shub_statue_stone"));
