...
public class BlockRenderStatue extends BlockEntityRenderer<BlockEntityStatue> {
    public BlockRenderStatue(BlockEntityRenderDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(BlockEntityStatue entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        matrices.push();
