...
public class BlockRenderOctagram extends BlockEntityRenderer<BlockEntityOctagram> {
    public static final RenderLayer OCTAGRAM_RENDER_LAYER;

    public BlockRenderOctagram(BlockEntityRenderDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(BlockEntityOctagram entity, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        Sprite sprite = ClientProxy.getOctagramTextureFor(entity).getSprite();
