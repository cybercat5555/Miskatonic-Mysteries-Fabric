...
public class MMREICompat implements REIClientPlugin {
	...
	public static final CategoryIdentifier<ChemistrySetCategory.ChemistryDisplay> CHEMISTRY = CategoryIdentifier
		.of(new Identifier(Constants.MOD_ID, "chemistry"));
	public static final CategoryIdentifier<OctagramRiteCategory.OctagramDisplay> OCTAGRAM_RITE = CategoryIdentifier
		.of(new Identifier(Constants.MOD_ID, "octagram_rite"));
