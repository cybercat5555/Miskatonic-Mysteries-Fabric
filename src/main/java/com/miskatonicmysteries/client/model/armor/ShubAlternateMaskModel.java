...
public class ShubAlternateMaskModel extends Model {
    ...
    public ShubAlternateMaskModel() {
        ...
        head.setPivot(0.0F, -6.4F, 1.2F);
        armorHead.addChild(head);
        setRotationAngle(head, 0.9599F, 0.0F, 0.0F);
        head.setTextureOffset(0, 0).addCuboid(-4.0F, -5.1F, -5.1F, 8.0F, 6.0F, 6.0F, 0.15F, false);

        lUpperJaw = new ModelPart(this);
        lUpperJaw.setPivot(-2.9F, -2.0F, -4.8F);
        head.addChild(lUpperJaw);
        setRotationAngle(lUpperJaw, 0.1396F, -0.2269F, 0.0F);
        lUpperJaw.setTextureOffset(16, 16).addCuboid(-1.0F, -1.5F, -5.1F, 2.0F, 3.0F, 6.0F, 0.0F, true);

        snout = new ModelPart(this);
        snout.setPivot(0.0F, -4.2F, -4.7F);
        head.addChild(snout);
        setRotationAngle(snout, 0.4363F, 0.0F, 0.0F);
        snout.setTextureOffset(0, 12).addCuboid(-2.5F, -1.0F, -5.8F, 5.0F, 2.0F, 6.0F, 0.0F, false);

        rUpperJaw = new ModelPart(this);
        rUpperJaw.setPivot(2.9F, -2.0F, -4.8F);
        head.addChild(rUpperJaw);
        setRotationAngle(rUpperJaw, 0.1396F, 0.2269F, 0.0F);
        rUpperJaw.setTextureOffset(16, 16).addCuboid(-1.0F, -1.5F, -5.1F, 2.0F, 3.0F, 6.0F, 0.0F, false);
        ...
        lHorn01.setTextureOffset(0, 25).addCuboid(-0.7F, -2.4F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, true);
        ...
        lHorn2.setTextureOffset(1, 21).addCuboid(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.25F, false);
        ...
        rHorn01.setTextureOffset(0, 25).addCuboid(-1.3F, -2.4F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        rHorn02.setTextureOffset(1, 21).addCuboid(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.25F, false);
        ...
        rHorn03.setTextureOffset(1, 21).addCuboid(-0.6F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        rHorn04.setTextureOffset(21, 28).addCuboid(-0.6F, -1.6F, -0.5F, 1.0F, 2.0F, 1.0F, -0.1F, false);

        strapL = new ModelPart(this);
        strapL.setPivot(3.3F, -5.3F, -4.4F);
        armorHead.addChild(strapL);
        strapL.setTextureOffset(4, 26).addCuboid(0.0F, -0.5F, 4.0F, 1.0F, 1.0F, 5.0F, 0.0F, false);

        strapB = new ModelPart(this);
        strapB.setPivot(0.0F, 0.0F, 8.5F);
        strapL.addChild(strapB);
        strapB.setTextureOffset(13, 26).addCuboid(-6.95F, -0.49F, -0.51F, 7.0F, 1.0F, 1.0F, 0.0F, false);

        strapR = new ModelPart(this);
        strapR.setPivot(-3.3F, -5.55F, -4.4F);
        armorHead.addChild(strapR);
        strapR.setTextureOffset(4, 26).addCuboid(-1.0F, -0.25F, 4.0F, 1.0F, 1.0F, 5.0F, 0.0F, false);
    }
