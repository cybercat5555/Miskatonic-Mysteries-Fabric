...
public class HasturObeliskModel extends Model {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData prongN02 = prongN01.addChild("prongN02",
												   ModelPartBuilder.create().uv(69, 0)
													   .cuboid(-1.5628F, -3.147F, -1.5F, 2.0F, 4.0F, 3.0F, new Dilation(0.1F)),
		...
		ModelPartData prongN04 = prongN03.addChild("prongN04",
												   ModelPartBuilder.create().uv(45, 3)
													   .cuboid(-3.0668F, 0.1759F, -1.0F, 4.0F, 1.0F, 2.0F, new Dilation(0.0F)),
