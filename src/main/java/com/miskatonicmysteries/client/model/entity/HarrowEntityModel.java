...
public class HarrowEntityModel extends EntityModel<HarrowEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData lLargeTentacle02 = lLargeTentacle01.addChild("lLargeTentacle02",
																   ModelPartBuilder.create()
																	   .uv(14, 1).cuboid(-0.51F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
																						 new Dilation(-0.1F, -0.1F, -0.1F)),
		...
		ModelPartData rLargeTentacle02 = rLargeTentacle01.addChild("rLargeTentacle02",
																   ModelPartBuilder.create()
																	   .uv(14, 1).cuboid(-0.49F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
																						 new Dilation(-0.1F, -0.1F, -0.1F)),
																   ModelTransform.of(0.0F, 1.8F, 0.0F, 0.0873F, 0.0F, 0.0F));
	...
	@Override
	public void setAngles(HarrowEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
						  float headPitch) {
	...
	private void animateTentacle(ModelPart segment1, ModelPart segment2, ModelPart segment3, float base1, float base2, float base3,
								 float runVar, float speedFac, float distanceMult) {
