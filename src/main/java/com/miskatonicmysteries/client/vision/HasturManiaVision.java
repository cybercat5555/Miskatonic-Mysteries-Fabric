...
public class HasturManiaVision extends VisionSequence {
    ...
    private void renderDefaultVersion(int width, int height, float backgroundProgress, Tessellator tessellator, BufferBuilder bufferBuilder, MatrixStack matrix, float tickDelta) {
        matrix.push();
    ...
    private void renderLines(int width, int height, float backgroundProgress, Tessellator tessellator, BufferBuilder bufferBuilder, MatrixStack matrix, float tickDelta) {
        float scale = 0.5F;
    ...
    private void renderDvdBounce(int width, int height, float backgroundProgress, Tessellator tessellator, BufferBuilder bufferBuilder, MatrixStack matrix, float tickDelta) {
