...
public class MMBlessings {
    public static final Blessing CHARMING_PERSONALITY = new Blessing(new Identifier(Constants.MOD_ID, "charming_personality"), MMAffiliations.HASTUR);
    ...
    public static final Blessing BNUUY = new Blessing(new Identifier(Constants.MOD_ID, "fuckin_bnuuy"), MMAffiliations.HASTUR);
