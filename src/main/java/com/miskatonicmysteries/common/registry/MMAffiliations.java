...
public class MMAffiliations {
	...
	public static final Affiliation NONE = new Affiliation(new Identifier(MOD_ID, "none"), new float[]{1, 1, 1}, 0xFFFDFDC1, 0xFFF5CE8C);
	public static final Affiliation HASTUR = new Affiliation(new Identifier(MOD_ID, "hastur"), new float[]{1, 1, 0}, 0xFFDCC52E, 0xFFF5CE8C,
															 MMBlessings.CHARMING_PERSONALITY, MMBlessings.MAGIC_BOOST, MMBlessings.ROYAL_ENTOURAGE);
	...
	public static final Affiliation YOG = new Affiliation(new Identifier(MOD_ID, "yog"), new float[]{1F, 0.2F, 1F});
