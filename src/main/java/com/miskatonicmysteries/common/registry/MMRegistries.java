...
public class MMRegistries {
    ...
    public static final Registry<InstabilityEvent> INSTABILITY_EVENTS = FabricRegistryBuilder.createSimple(InstabilityEvent.class, new Identifier(Constants.MOD_ID, "instability_event")).buildAndRegister();
