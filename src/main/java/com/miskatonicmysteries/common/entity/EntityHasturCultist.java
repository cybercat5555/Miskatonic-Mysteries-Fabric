...
public class EntityHasturCultist extends PathAwareEntity implements Angerable, Affiliated {
    protected static final TrackedData<Integer> VARIANT = DataTracker.registerData(EntityHasturCultist.class, TrackedDataHandlerRegistry.INTEGER);
    protected static final TrackedData<Boolean> ASCENDED = DataTracker.registerData(EntityHasturCultist.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    */
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(0, new RevengeGoal(this, EntityHasturCultist.class).setGroupRevenge());
        ...
        this.targetSelector.add(2, new FollowTargetGoal<>(this, HostileEntity.class, 5, true, true, mob -> !(mob instanceof EntityHasturCultist) && !(mob instanceof CreeperEntity)));
