...
public class BrokenVeilRite extends SpawnerTrapRite {
    public BrokenVeilRite() {
        super(new Identifier(Constants.MOD_ID, "broken_veil"), null,
                ...
                Ingredient.ofItems(MMObjects.INCANTATION_YOG), Ingredient.ofItems(Items.PHANTOM_MEMBRANE), Ingredient.ofItems(Items.ENDER_PEARL), Ingredient.ofItems(MMObjects.INFESTED_WHEAT));
    }
