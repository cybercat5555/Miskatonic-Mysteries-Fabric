...
public class ModCommand {
	...
	public static void setup() {
		ArgumentTypes.register("insanity_event", ModCommand.InsanityEventArgumentType.class,
			new ConstantArgumentSerializer(IdentifierArgumentType::identifier));
		...
		builder.then(CommandManager.literal("stats")
			...
			.then(CommandManager.argument("player", EntityArgumentType.player())
				.executes(context -> giveStatFeedback(context, EntityArgumentType.getPlayer(context, "player")))));
		builder.then(CommandManager.literal("sanity")
			.then(CommandManager.literal("get").executes(context -> giveSanityFeedback(context, context.getSource().getPlayer()))
				.then(CommandManager.argument("player", EntityArgumentType.players()).executes(context -> giveSanityFeedback(context,
					EntityArgumentType.getPlayers(context, "player")
						.toArray(new ServerPlayerEntity[EntityArgumentType.getPlayers(context, "player").size()])))))

			.then(CommandManager.literal("getMax").executes(context -> giveMaxSanityFeedback(context, context.getSource().getPlayer()))
				.then(CommandManager.argument("player", EntityArgumentType.players()).executes(context -> giveMaxSanityFeedback(context,
					EntityArgumentType.getPlayers(context, "player")
						.toArray(new ServerPlayerEntity[EntityArgumentType.getPlayers(context, "player").size()])))))
			...
			.then(CommandManager.literal("set").then(
				CommandManager.argument("value", IntegerArgumentType.integer(0, Constants.DataTrackers.SANITY_CAP)).executes(
					...
					.then(CommandManager.argument("player", EntityArgumentType.players()).executes(
						context -> setSanity(context, IntegerArgumentType.getInteger(context, "value"),
							EntityArgumentType.getPlayers(context, "player")
								.toArray(new ServerPlayerEntity[EntityArgumentType.getPlayers(context, "player").size()]))))))

			.then(CommandManager.literal("playInsanityEvent").then(CommandManager.argument("id", InsanityEventArgumentType.insanityEvent())
				.executes(context -> playInsanityEvent(context, InsanityEventArgumentType.getInsanityEvent(context, "id"),
					context.getSource().getPlayer()))
				.then(CommandManager.argument("player", EntityArgumentType.players()).executes(
					context -> playInsanityEvent(context, InsanityEventArgumentType.getInsanityEvent(context, "id"),
						EntityArgumentType.getPlayers(context, "player")
							.toArray(new ServerPlayerEntity[EntityArgumentType.getPlayers(context, "player").size()]))))))

			.then(CommandManager.literal("sanityExpansion")
				.then(CommandManager.literal("add")
					.then(CommandManager.argument("name", StringArgumentType.string()).then(
						CommandManager.argument("value", IntegerArgumentType.integer()).executes(
							context -> addSanityExpansion(context, StringArgumentType.getString(context, "name"),
								IntegerArgumentType.getInteger(context, "value"), context.getSource().getPlayer()))
							.then(CommandManager.argument("player", EntityArgumentType.players()).executes(
								context -> addSanityExpansion(context, StringArgumentType.getString(context, "name"),
									IntegerArgumentType.getInteger(context, "value"),
									EntityArgumentType.getPlayers(context, "player").toArray(new ServerPlayerEntity[0])))))))
				.then(CommandManager.literal("remove")
					.then(CommandManager.argument("name", StringArgumentType.string()).executes(
						context -> removeSanityExpansion(context, StringArgumentType.getString(context, "name"),
							context.getSource().getPlayer()))
						.then(CommandManager.argument("player", EntityArgumentType.players()).executes(
							context -> removeSanityExpansion(context, StringArgumentType.getString(context, "name"),
								EntityArgumentType.getPlayers(context, "player")
				...
				.then(CommandManager.literal("clear")
					...
					.then(CommandManager.argument("player", EntityArgumentType.players()).executes(context -> clearSanityExpansions(context,
						EntityArgumentType.getPlayers(context, "player")
							.toArray(new ServerPlayerEntity[EntityArgumentType.getPlayers(context, "player").size()])))))));
		...
		for (Identifier id : MMRegistries.AFFILIATIONS.getIds()) {
			setAscensionBuilder.then(CommandManager.literal(id.toString())
				.executes(context -> setAscension(context, id, Ascendant.of(context.getSource().getPlayer()).get().getAscensionStage(),
					context.getSource().getPlayer()))
				.then(CommandManager.argument("stage", IntegerArgumentType.integer(0, 10)).executes(
					context -> setAscension(context, id, IntegerArgumentType.getInteger(context, "stage"), context.getSource().getPlayer()))
					.then(CommandManager.argument("player", EntityArgumentType.player()).executes(
						context -> setAscension(context, id, IntegerArgumentType.getInteger(context, "stage"),
		...
		spellBuilder.then(CommandManager.literal("setMax").then(
			CommandManager.argument("value", IntegerArgumentType.integer(0, Constants.DataTrackers.SPELL_CAP)).executes(
				context -> setMaxSpells(context, IntegerArgumentType.getInteger(context, "value"), context.getSource().getPlayer()))
				.then(CommandManager.argument("player", EntityArgumentType.players()).executes(
					context -> setMaxSpells(context, IntegerArgumentType.getInteger(context, "value"),
						EntityArgumentType.getPlayers(context, "player")
							.toArray(new ServerPlayerEntity[EntityArgumentType.getPlayers(context, "player").size()]))))));
		spellBuilder.then(CommandManager.literal("setPowerPool").then(
			CommandManager.argument("value", IntegerArgumentType.integer(0, Constants.DataTrackers.SPELL_CAP * 3)).executes(
				context -> setPowerPool(context, IntegerArgumentType.getInteger(context, "value"), context.getSource().getPlayer()))
				.then(CommandManager.argument("player", EntityArgumentType.players()).executes(
					context -> setPowerPool(context, IntegerArgumentType.getInteger(context, "value"),
						EntityArgumentType.getPlayers(context, "player")
							.toArray(new ServerPlayerEntity[EntityArgumentType.getPlayers(context, "player").size()]))))));
			...
			for (Identifier effectId : MMRegistries.SPELL_EFFECTS.getIds()) {
				mediumBuilder.then(CommandManager.literal(effectId.toString())
					...
					.then(CommandManager.argument("intensity", IntegerArgumentType.integer(0))
						.executes(context -> castSpell(mediumId, effectId, IntegerArgumentType.getInteger(context, "intensity"),
							context.getSource().getPlayer()))
						.then(CommandManager.argument("сaster", EntityArgumentType.player())
							.executes(context -> castSpell(mediumId, effectId, IntegerArgumentType.getInteger(context, "intensity"),
								EntityArgumentType.getPlayer(context, "сaster"))))));
			}
		...
		visionBuilder.then(CommandManager.argument("id", IdentifierArgumentType.identifier())
			...
			.then(CommandManager.argument("players", EntityArgumentType.players())
				.executes(context -> displayVision(context, IdentifierArgumentType.getIdentifier(context, "id"),
					EntityArgumentType.getPlayers(context, "players").toArray(new ServerPlayerEntity[0])))));
	...
	private static int displayVision(CommandContext<ServerCommandSource> context, Identifier visionId, ServerPlayerEntity... players) {
		for (ServerPlayerEntity player : players) {
			...
			context.getSource().sendFeedback(
				new TranslatableText("miskatonicmysteries.command.display_vision", visionId.toString(), player.getDisplayName()), true);
		}
	...
	private static int spawnProtagonist(CommandContext<ServerCommandSource> context, PlayerEntity player) {
		...
		if (spawned) {
			context.getSource()
				.sendFeedback(new TranslatableText("miskatonicmysteries.command.summon_investigator", player.getDisplayName()), true);
		} else {
	...
	private static int playInsanityEvent(CommandContext<ServerCommandSource> context, Identifier id, ServerPlayerEntity... players) {
		...
		if (event != null) {
			for (ServerPlayerEntity player : players) {
				context.getSource()
					.sendFeedback(new TranslatableText("miskatonicmysteries.command.execute_insanity_event", id.toString()), false);
				Sanity.of(player).ifPresent(sanity -> event.execute(player, sanity));
			}
			return 10;
		} else {
			context.getSource()
				.sendError(new TranslatableText("miskatonicmysteries.command.execute_insanity_event.failure", id.toString()));
		}
		return 0;
	}
			...
			Sanity.of(player).ifPresent(sanity -> {
				if (sanity.getSanityCapExpansions().isEmpty()) {
					context.getSource().sendError(
						new TranslatableText("miskatonicmysteries.command.clear_expansions.none_failure", player.getDisplayName()));
				} else {
	...
	private static int addSanityExpansion(CommandContext<ServerCommandSource> context, String name, int value,
		...
		for (ServerPlayerEntity player : players) {
			Sanity.of(player).ifPresent(sanity -> {
				...
				if (contains) {
					context.getSource().sendError(
						new TranslatableText("miskatonicmysteries.command.add_sanity_expansion.contains_failure", name,
							player.getDisplayName()));
				} else {
					((Sanity) player).addSanityCapExpansion(name, value);
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.add_sanity_expansion", name, value, player.getDisplayName()),
						true);
				}
			});
	...
	private static int removeSanityExpansion(CommandContext<ServerCommandSource> context, String name, ServerPlayerEntity... players) {
		for (ServerPlayerEntity player : players) {
			Sanity.of(player).ifPresent(sanity -> {
				...
				if (!contains) {
					context.getSource().sendError(
						new TranslatableText("miskatonicmysteries.command.remove_sanity_expansion.failure", name, player.getDisplayName()));
				} else {
					sanity.removeSanityCapExpansion(name);
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.remove_sanity_expansion", name, player.getDisplayName()), true);
				}
			});
	...
	private static int giveMaxSanityFeedback(CommandContext<ServerCommandSource> context, ServerPlayerEntity... players)
		...
		for (ServerPlayerEntity player : players) {
			if (Sanity.of(player).isPresent()) {
				...
				MutableText expansionText = sanity.getSanityCapExpansions().isEmpty() ? new TranslatableText(
					"miskatonicmysteries.command.get_max_sanity.no_expansions")
					: new TranslatableText("miskatonicmysteries.command.get_max_sanity.expansions");
				sanity.getSanityCapExpansions().forEach((s, i) -> {
					expansionText.append("\n");
					expansionText.append(new LiteralText(s + ": ")
						.append(new LiteralText(Integer.toString(i)).formatted(i <= 0 ? Formatting.RED : Formatting.GREEN)));
				});
				...
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.get_max_sanity.self", value)
						.setStyle(Style.EMPTY.withHoverEvent(hoverInfo)), false);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.get_max_sanity", player.getDisplayName(), value)
							.setStyle(Style.EMPTY.withHoverEvent(hoverInfo)), false);
				}
	...
	private static int setSanity(CommandContext<ServerCommandSource> context, int value, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (Sanity.of(player).isPresent()) {
				Sanity sanity = Sanity.of(player).get();
				...
				if (player.equals(context.getSource().getPlayer())) {
					...
					context.getSource()
						.sendFeedback(new TranslatableText("miskatonicmysteries.command.set_sanity", player.getDisplayName(), value), true);
				}
			}
		}
	...
	private static int setMaxSpells(CommandContext<ServerCommandSource> context, int value, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (SpellCaster.of(player).isPresent()) {
				...
				if (player.equals(context.getSource().getPlayer())) {
					...
					context.getSource()
						.sendFeedback(new TranslatableText("miskatonicmysteries.command.set_max_spells", player.getDisplayName(), value),
							true);
				}
			}
		}
	...
	private static int setPowerPool(CommandContext<ServerCommandSource> context, int value, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (SpellCaster.of(player).isPresent()) {
				SpellCaster caster = SpellCaster.of(player).get();
				...
				if (player.equals(context.getSource().getPlayer())) {
					...
					context.getSource()
						.sendFeedback(new TranslatableText("miskatonicmysteries.command.set_power_pool", player.getDisplayName(), value),
							true);
				}
			}
		}
	...
	private static int learnSpellEffect(CommandContext<ServerCommandSource> context, Identifier effect, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (SpellCaster.of(player).isPresent()) {
				SpellCaster caster = SpellCaster.of(player).get();
				...
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.learn_spell.self",
						new TranslatableText(spellEffect.getTranslationString())), true);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.learn_spell", player.getDisplayName(),
							new TranslatableText(spellEffect.getTranslationString())), true);
				}
			}
		}
	...
	private static int removeSpellEffect(CommandContext<ServerCommandSource> context, Identifier effect, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (SpellCaster.of(player).isPresent()) {
				SpellCaster caster = SpellCaster.of(player).get();
				...
				caster.syncSpellData();
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.removed_spell.self",
						new TranslatableText(spellEffect.getTranslationString())), true);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.removed_spell", player.getDisplayName(),
							new TranslatableText(spellEffect.getTranslationString())), true);
				}
			}
		}
	...
	private static int learnMedium(CommandContext<ServerCommandSource> context, Identifier medium, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (SpellCaster.of(player).isPresent()) {
				SpellCaster caster = SpellCaster.of(player).get();
				...
				caster.syncSpellData();
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.learn_medium.self",
						new TranslatableText(spellMedium.getTranslationString())), true);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.learn_medium", player.getDisplayName(),
							new TranslatableText(spellMedium.getTranslationString())), true);
				}
			}
		}
	...
	private static int removeMedium(CommandContext<ServerCommandSource> context, Identifier medium, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (SpellCaster.of(player).isPresent()) {
				SpellCaster caster = SpellCaster.of(player).get();
				...
				caster.syncSpellData();
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.remove_medium.self",
						new TranslatableText(spellMedium.getTranslationString())), true);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.remove_medium", player.getDisplayName(),
							new TranslatableText(spellMedium.getTranslationString())), true);
				}
			}
		}
	...
	private static int addBlessing(CommandContext<ServerCommandSource> context, Identifier blessingId, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (Ascendant.of(player).isPresent()) {
				...
				if (ascendant.getBlessings().size() < Constants.DataTrackers.MAX_BLESSINGS) {
					...
					if (player.equals(context.getSource().getPlayer())) {
						context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.add_blessing.self",
							new TranslatableText(blessing.getTranslationString())), true);
					} else {
						context.getSource().sendFeedback(
							new TranslatableText("miskatonicmysteries.command.add_blessing", player.getDisplayName(),
								new TranslatableText(blessing.getTranslationString())), true);
					}
				} else {
					context.getSource()
						.sendError(new TranslatableText("miskatonicmysteries.command.add_blessing.failure", player.getDisplayName()));
				}
			}
		}
		return 0;
	...
	private static int removeBlessing(CommandContext<ServerCommandSource> context, Identifier blessingId, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (Ascendant.of(player).isPresent()) {
				Ascendant ascendant = Ascendant.of(player).get();
				...
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.remove_blessing.self",
						new TranslatableText(blessing.getTranslationString())), true);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.remove_blessing", player.getDisplayName(),
							new TranslatableText(blessing.getTranslationString())), true);
				}
			}
		}
	...
	private static int giveBlessingFeedback(CommandContext<ServerCommandSource> context, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (Ascendant.of(player).isPresent()) {
				Ascendant ascendant = Ascendant.of(player).get();
				...
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource().sendFeedback(new TranslatableText("miskatonicmysteries.command.get_blessings.self", value)
						.setStyle(Style.EMPTY.withHoverEvent(hoverInfo)), false);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.get_blessings", player.getDisplayName(), value)
							.setStyle(Style.EMPTY.withHoverEvent(hoverInfo)), false);
				}
			}
	...
	private static int giveAscensionFeedback(CommandContext<ServerCommandSource> context, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (Ascendant.of(player).isPresent() && Affiliated.of(player).isPresent()) {
				...
				if (player.equals(context.getSource().getPlayer())) {
					...
					context.getSource()
						.sendFeedback(new TranslatableText("miskatonicmysteries.command.get_ascension", player.getDisplayName()), false);
				}
				context.getSource().sendFeedback(
					new TranslatableText("miskatonicmysteries.command.get_ascension.apparent_path", apparentAffiliation.getId()), false);
				context.getSource()
					.sendFeedback(new TranslatableText("miskatonicmysteries.command.get_ascension.path", affiliation.getId()), false);
	...
	private static int setAscension(CommandContext<ServerCommandSource> context, Identifier affiliation, int stage,
		ServerPlayerEntity... players) throws CommandSyntaxException {
		for (ServerPlayerEntity player : players) {
			if (Ascendant.of(player).isPresent() && Affiliated.of(player).isPresent()) {
				...
				if (player.equals(context.getSource().getPlayer())) {
					context.getSource()
						.sendFeedback(new TranslatableText("miskatonicmysteries.command.set_ascension.self", affiliation, stage), false);
				} else {
					context.getSource().sendFeedback(
						new TranslatableText("miskatonicmysteries.command.set_ascension", player.getDisplayName(), affiliation, stage),
						false);
				}
			}
	...
	private static int giveStatFeedback(CommandContext<ServerCommandSource> context, ServerPlayerEntity player)
		throws CommandSyntaxException {
		context.getSource().sendFeedback(
			new TranslatableText("miskatonicmysteries.command.stats", player.getDisplayName()).setStyle(Style.EMPTY.withBold(true)), false);
	...
	private static int giveSanityFeedback(CommandContext<ServerCommandSource> context, ServerPlayerEntity... players)
		throws CommandSyntaxException {
		int returnValue = 0;
		for (ServerPlayerEntity player : players) {
			...
			if (player.equals(context.getSource().getPlayer())) {
				...
				context.getSource()
					.sendFeedback(new TranslatableText("miskatonicmysteries.command.get_sanity", player.getDisplayName(), value), false);
			}
			if (value > returnValue) {
				returnValue = value;
			}
