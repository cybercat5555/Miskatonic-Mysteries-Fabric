...
public class CapabilityUtil {
    ...
    public static boolean isAffiliated(Entity entity) {
        return Affiliated.of(entity).isPresent() && Affiliated.of(entity).get().getAffiliation(false) != MMAffiliations.NONE;
    }

    public static Affiliation getAffiliation(Entity entity, boolean apparent) {
        return Affiliated.of(entity).map(affiliated -> affiliated.getAffiliation(apparent)).orElse(MMAffiliations.NONE);
    }
