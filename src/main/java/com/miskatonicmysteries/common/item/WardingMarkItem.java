...
public class WardingMarkItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> lines, TooltipContext ctx) {
        ...
        lines.add(new TranslatableText("tooltip.%s.place_instruction".formatted(Constants.MOD_ID), "§b" + I18n.translate(Items.GLOW_INK_SAC.getTranslationKey()) + "§8").formatted(Formatting.GRAY));
    }
}
