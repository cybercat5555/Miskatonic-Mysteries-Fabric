...
public abstract class GunItem extends Item {
    ...
    public void shoot(World world, LivingEntity player, ItemStack stack) {
        ...
        world.playSound(null, player.getX(), player.getY(), player.getZ(), MMSounds.GUN_SHOT, SoundCategory.PLAYERS, 0.6F, 1.0F / (world.random.nextFloat() * 0.2F + (isHeavy() ? 1F : 0.5F)));
