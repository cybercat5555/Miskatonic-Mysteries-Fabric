...
/**
 * Modifier callback for adjusting the banner pattern limit based on the player.
 */
@FunctionalInterface
public interface PatternLimitModifier {
	...
	/**
	 * Compute the banner pattern limit for the given player, given the current banner pattern limit. The banner pattern limit is the total number of
	 * vanilla banner patterns plus loom patterns on the banner (excluding the "base" vanilla banner pattern).
	 */
